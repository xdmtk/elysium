...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    wrapper.innerHTML =
      '<div style="display: none; overflow: hidden; position: relative; width: 1px; height: 0px;">' + // Wraps and hides input textarea
...
oi// All functions that need access to the editor's state live inside
// the CodeMirror function. Below that, at the bottom of the file,
// some utilities are defined.
