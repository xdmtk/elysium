...
void CoreSettings::setConfigEnvironment() {
    ...
    if (user == "erick") env = ConfigEnvironment::ErickDev; return;
    if (user == "josh") env = ConfigEnvironment::JoshDev; return;
    if (user == "nick") env = ConfigEnvironment::NickDev; return;
    if (user == "daniel") env = ConfigEnvironment::DanielDev; return;
    if (user == "sebastian") env = ConfigEnvironment::SebastianDev; return;
    if (user == "ubuntu") env = ConfigEnvironment::Production; return;
#endif
